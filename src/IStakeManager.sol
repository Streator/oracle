 ...
 */
 function setConfiguration(uint224 registrationDepositAmount, uint32 registrationWaitTime) external;
 ...
 */
 function unstake(uint224 amount) external;
 ...
 */
 function slash(address staker, uint224 amount) external;
}
